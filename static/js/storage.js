...
export const KEYS = {
  ...
  MODELS_EXPANDED: 'talos-model-expanded',
  MODEL_ENDPOINTS: 'talos-model-endpoints',
  MODEL_SELECTED: 'talos-selected-model',
  SORT_ORDER: 'talos-sessions-sort',
  CHAT_SEARCH_SCOPE: 'talos-search-scope',
  INCOGNITO: 'talos-incognito',
  RAG_ACTIVE: 'talos-rag-active',
  MCP_ACTIVE: 'talos-mcp-active',
