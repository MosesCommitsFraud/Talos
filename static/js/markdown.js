...
function initMermaid() {
  if (!window.mermaid || window.__talosMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__talosMermaidReady = true;
}
window.talosInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'talos-thinking-expanded';
