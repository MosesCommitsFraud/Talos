...
~~teacher escalation, second opinion, other models need to go. web search relics also and tasks~~ done
~~memory needs removal, webhooks too~~ done
context window explanation on meter
