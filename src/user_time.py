...
def current_datetime_prompt(now_utc: Optional[datetime] = None) -> str:
    ...
    return (
        ...
        "**Your training data ends well before today's date above.** Anything you "
        "remember as 'upcoming', 'not out yet' or 'hasn't happened yet' may already "
        "be long past — that is your cutoff talking, not the present. So never "
