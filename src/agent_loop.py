...
PLAN_MODE_DIRECTIVE = (
    ...
    "You are in PLAN MODE. Your ONLY job this turn is to PROPOSE a plan for the user "
    "to approve. You have NOT done anything yet. Do NOT claim you created, wrote, ran, "
    "sent, or changed anything.\n\n"
    "ABSOLUTE RULE — DO NOT MUTATE ANYTHING. Every write/state-changing tool, "
    "including bash/python, is disabled this turn and will be rejected. Use the "
    "read-only tools listed below to investigate files and gather context FIRST, so "
    "your plan is concrete and grounded in what's actually there — not guesses.\n\n"
    ...
    "outcome. State the key constraints and what you learned from investigating "
    "(name the specific files, functions, or components you inspected).\n\n"
    "## Approach\n"
    "The detailed approach: what you will change and how, the design decisions and "
    "trade-offs, and the specific files/components involved (use real paths you found). "
    "Explain enough that the user can judge the approach before any code is written.\n\n"
    "## Plan\n"
    "A GitHub-style checklist, one concrete action per line:\n"
    "- [ ] first action you will take once approved\n"
    "- [ ] next action\n\n"
    "## Verification\n"
    "How the change will be proven to work end-to-end — commands to run, UI flows to "
    "exercise, and any tests to add.\n\n"
