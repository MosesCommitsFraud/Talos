...
PLAN_MODE_DIRECTIVE = (
    ...
    "You are in PLAN MODE. Your ONLY job this turn is to PROPOSE a thorough, "
    ...
    "INVESTIGATE FIRST. Do not plan from assumptions. Use the read-only tools "
    "(read_file, grep, glob, ls, search, …) to actually open the relevant files, "
    "trace how the affected code works today, and find existing patterns/utilities to "
    "reuse. Keep investigating until you could implement this yourself without "
    "guessing. A plan grounded in real files beats a vague one every time. Think hard "
    "about edge cases, failure modes, and how this interacts with existing behaviour.\n\n"
    ...
    "file paths, functions, and symbols you found (use `backticks`). Match the depth "
    "and rigour of a senior engineer's design doc — thorough, but no filler.\n\n"
    "## Context\n"
