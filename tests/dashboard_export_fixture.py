...
styles = {
    "16:9": "#td-artboard .panel.full,#td-artboard .insights,#td-artboard .source{display:none}#td-artboard .plot{height:250px}",
    "a4": "#td-artboard .panels{grid-template-columns:1fr}#td-artboard .plot{height:300px}",
