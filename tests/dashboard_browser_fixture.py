...
td.ECHARTS_BUNDLE.write_text(
    (root / "node_modules/echarts/dist/echarts.min.js").read_text(encoding="utf-8")
    + "\n;\n"
    + (root / "node_modules/echarts/i18n/langDE.js").read_text(encoding="utf-8"),
    encoding="utf-8",
)
for package, source in [
    ("echarts-gl", "echarts-gl/dist/echarts-gl.min.js"),
    ("echarts-stat", "echarts-stat/dist/ecStat.min.js"),
]:
        ...
        "series": [
            {
                "type": "tree",
                "data": [
                    {"name": "Talos", "children": [{"name": "Analyse"}, {"name": "Dashboard"}]}
                ],
...
add(
    ...
    {
        "parallelAxis": [
            {"dim": i, "name": n} for i, n in enumerate(["Kosten", "Qualität", "Zeit"])
        ],
        "series": [{"type": "parallel", "data": [[1, 4, 2], [2, 3, 5], [5, 1, 3]]}],
    },
)
add(
    "matrix",
    {
        "matrix": {"x": {"data": ["A", "B"]}, "y": {"data": ["U", "V"]}},
        "visualMap": {"min": 0, "max": 40, "dimension": 2},
        "series": [
            {
                "type": "heatmap",
                "coordinateSystem": "matrix",
                "data": [["A", "U", 10], ["A", "V", 20], ["B", "U", 30], ["B", "V", 40]],
                "label": {"show": True},
            }
        ],
    },
        ...
        "series": [
            {
                ...
                "data": [[1, 2], [3, 4]],
                "renderItem": td.js(
                    "function(p,api) {const xy=api.coord([api.value(0),api.value(1)]); return {type:'circle',shape:{cx:xy[0],cy:xy[1],r:12},style:{fill:'#2a78d6'}};}"
                ),
            }
        ],
    },
        ...
        "series": [
            {
                "type": "map",
                "map": "smoke",
                "data": [{"name": "Demo", "value": 42}],
                "label": {"show": True},
            }
        ]
    },
    data=geo,
    setup=td.js("function(c,e,data){e.registerMap('smoke',data)}"),
)
add(
    "zoom",
    {
        ...
        "series": [
            {"type": "line", "name": "Ist", "data": [1, 2, 3, 4]},
            {"type": "line", "name": "Plan", "data": [2, 3, 4, 5]},
        ],
    },
)
add(
    "regression",
    {
        ...
        "xAxis": {},
        "yAxis": {},
        "series": [{"type": "scatter", "datasetIndex": 0}, {"type": "line", "datasetIndex": 1}],
    },
    extensions=["echarts-stat"],
    setup=td.js("function(c,e){e.registerTransform(ecStat.transform.regression)}"),
)
add(
    "gl",
    {
        ...
        "grid3D": {},
        "series": [
            {"type": "scatter3D", "data": [[1, 2, 3], [2, 3, 1], [3, 1, 2]], "symbolSize": 15}
        ],
    },
...
td.dashboard(
    str(root / "smoke.html"),
    title="ECharts – Funktionsprüfung",
    subtitle="Synthetische Testdaten",
    charts=charts,
)
