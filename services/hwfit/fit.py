...
def rank_models(system, use_case=None, limit=50, search=None, sort="score", quant=None, target_context=None, fit_only=False):
    ...
    for m in models:
        ...
        # MLX needs the mlx_lm runtime, which Talos does not generate serve
        ...
        # otherwise prefer GGUF/Q* entries that Talos can route through
        ...
        #
        # Windows is the same: Talos only supports llama.cpp on Windows,
