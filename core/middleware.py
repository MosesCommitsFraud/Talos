...
INTERNAL_TOOL_TOKEN = os.environ.get("TALOS_INTERNAL_TOKEN") or secrets.token_hex(32)
INTERNAL_TOOL_HEADER = "X-Talos-Internal-Token"
...
def require_admin(request: Request):
    ...
    # (a) header-direct (caller set X-Talos-Internal-Token), or
